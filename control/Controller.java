...
import newview.InvaderInfoWindow;
...
public class Controller implements KeyListener, ActionListener, GameObserver {
    ...
    /**
     * The frames to hold the panel with the current view of the game and the secondary window during a game session.
     */
    private View view;
    private InvaderInfoWindow invaderInfoWindow;
    ...
    public void start() {
        ...
        invaderInfoWindow = new InvaderInfoWindow(300, 300); // Instantiate the window which will be used for extra info.
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (actionCommand.equals("newgame")) {
            ...
            gameControl = game;
            gameInfo = game;
            invaderInfoWindow.showInvaderInfoWindow(gameInfo); // Showing the second window during a game session.
    ...
    public void gameChanged() {
        if (gameInfo.isOver()) {
            invaderInfoWindow.hidePanel(); // Getting rid of the second window once the game is over.
